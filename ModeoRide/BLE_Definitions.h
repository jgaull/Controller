...
#define PROPERTY_STRAIN_DAMPING_CURVE 3
#define PROPERTY_STROKE_TIMEOUT_CYCLES 4
#define PROPERTY_MAX_EFFORT 5
#define PROPERTY_TORQUE_MULTIPLIER 6
#define PROPERTY_MAX_STRAIN_DAMPING_SPEED 7
#define PROPERTY_STRAIN_DAMPING_CONTROL_1_X 8
#define PROPERTY_STRAIN_DAMPING_CONTROL_1_Y 9
#define PROPERTY_STRAIN_DAMPING_CONTROL_2_X 10
#define PROPERTY_STRAIN_DAMPING_CONTROL_2_Y 11
